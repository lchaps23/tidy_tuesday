...
event_durations <- winter_olympics_26 |> 
  ...
  select(date, discipline_code, discipline_name, event_description, duration)
```
...
event_durations |> 
  ...
  labs(
    ...
    x = "Duration (minutes)",
    y = NULL,
    caption = "Data: Milano-Cortina 2026 | Disciplines ordered by median duration"
  ) +
